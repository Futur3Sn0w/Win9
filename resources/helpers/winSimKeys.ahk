...
; Remap Windows key to F24 ONLY when the Win9 simulator Electron window is focused.
...
; Forward Win+Shift+F through the same synthetic chord bridge so it can
; reuse the shell fullscreen toggle that also backs the Settings six-pack.
#+f::Send "^!+f"
#HotIf
